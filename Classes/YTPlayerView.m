...
- (BOOL)loadWithPlayerParams:(NSDictionary *)additionalPlayerParams {
  ...
  [playerParams setValue:[NSNumber numberWithInt:self.bounds.size.height] forKey:@"height"];
  [playerParams setValue:[NSNumber numberWithInt:self.bounds.size.width] forKey:@"width"];
